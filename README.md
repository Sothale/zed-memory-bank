...
Система теперь использует гибридную разметку для структурирования правил:
- **XML-обертка** обеспечивает парсинг и валидацию структуры
...
**Документация по разметке**: [docs/HYBRID_MARKUP_DOCUMENTATION.md](docs/HYBRID_MARKUP_DOCUMENTATION.md)
...
├── docs/
│   └── HYBRID_MARKUP_DOCUMENTATION.md # Документация по гибридной разметке
...
- **[Гибридная разметка](docs/HYBRID_MARKUP_DOCUMENTATION.md)** - Документация по XML+Markdown структуре
